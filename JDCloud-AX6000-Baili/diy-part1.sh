...
git clone https://github.com/kiddin9/openwrt-packages/tree/master/luci-app-store package/luci-app-store
git clone https://github.com/sirpdboy/luci-app-eqosplus package/luci-app-eqosplus
git clone https://github.com/kiddin9/openwrt-packages/tree/master/luci-app-ramfree package/luci-app-ramfree
